...
const GlobalFlexStyles = createGlobalStyle<{ variables: TVariables }>`
  ...
  .n-gap-1 { gap: ${(props) => props.variables["spacing.1"]}; }
  .n-gap-2 { gap: ${(props) => props.variables["spacing.2"]}; }
  .n-gap-3 { gap: ${(props) => props.variables["spacing.3"]}; }
  .n-gap-4 { gap: ${(props) => props.variables["spacing.4"]}; }
  .n-gap-5 { gap: ${(props) => props.variables["spacing.5"]}; }
  .n-gap-6 { gap: ${(props) => props.variables["spacing.6"]}; }
  .n-gap-7 { gap: ${(props) => props.variables["spacing.7"]}; }
  .n-gap-8 { gap: ${(props) => props.variables["spacing.8"]}; }
  .n-gap-9 { gap: ${(props) => props.variables["spacing.9"]}; }
  .n-gap-10 { gap: ${(props) => props.variables["spacing.10"]}; }
