...
export const GlobalCommonTypographyStyles = createGlobalStyle<{
  ...
  .n-font-size-default { font-size: ${(props) =>
    props.variables["font.size"]}; }
  small,.n-font-size-sm { font-size: ${(props) =>
    props.variables["font.size.small"]}; }
  .n-font-size-lg { font-size: ${(props) =>
    props.variables["font.size.large"]}; }
`;
